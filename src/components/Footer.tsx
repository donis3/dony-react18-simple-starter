		...
		<footer className="h-auto w-full bg-gray-800 bg-opacity-30 px-3 py-4 text-white ">
			<div className="container mx-auto flex h-full flex-col  gap-4 md:flex md:flex-row md:items-start  md:justify-between md:gap-8">
				<div className="flex  items-center justify-center font-bold  md:min-h-[40px] md:justify-start">
					<h3 className="font-headline text-xl">DonyReact</h3>
				</div>
				<div className="flex-1 ">
					<ul className="flex flex-wrap items-center justify-center gap-4 text-xs md:min-h-[40px] md:justify-start ">
						<li className="block  ">
							<a
								href="#"
			...
			<div className="container mx-auto  flex flex-col items-center justify-between gap-1 pt-5 text-xs opacity-50 md:flex-row">
